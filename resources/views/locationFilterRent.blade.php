  ...
  <div class="row" id="mobfilter">
   @foreach($location as $item)
      <div class="col-xs-6 col-md-3 col-sm-3" style="margin-bottom:15px;">
         ...
         <img src="{{ asset('images/photos')}}/{{$item->img1}}">
        <div class="caption">
...
<table class="table table-bordered table-responsive main_box" style="text-align: center;">
  ...
  <tbody style="text-align: center; " id="tbody">
      ...
      <tr style="color: #CC0000;" >
          <td scope="row"><a href="{{ url('mansion-detail')}}/{{$item->id}}"><img src="{{ asset('images/photos')}}/{{$item->img1}}" class="img-responsive" width="150px" height="50px"/></a></td>
...
<script> 
    ...
    $(document).ready(function() {
        $("#filter").change(function(){
          ...
          $.ajax({
          type: 'POST',
          url: "{{ url('filterdatalocationrent')}}",
          ...
          success: function(data){
            ...
            console.log(data)
                  ...
                  $.each(data, function(k,v){
                      ...
                      +v.id+" style='text-decoration: none;'><img src='{{ asset('images/photos')}}/"
